...
from data_utils import evaluate_acmgcn, normalize, gen_normalized_adjs, evaluate, evaluate_mlpnorm, evaluate_acmgcn, evaluate_wrgat, eval_acc, eval_rocauc, to_sparse_tensor, load_fixed_splits
...
model = parse_method(args, dataset, n, c, d, device, num_relations)
